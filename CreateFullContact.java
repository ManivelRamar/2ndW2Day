...
public class CreateFullContact 
{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Manivel");
		...
		driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("manveloffcl@gmail.com");
